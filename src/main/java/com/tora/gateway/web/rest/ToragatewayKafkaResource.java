...
@RestController
@RequestMapping("/api/toragateway-kafka")
public class ToragatewayKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ToragatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ToragatewayKafkaResource(KafkaProperties kafkaProperties) {
